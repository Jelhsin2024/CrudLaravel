...
const urlIndex = 'http://localhost:3000/platillos'
//const urlIndex = 'http://localhost:3000/platillosindex/'
//capturando tbody
        ...
        indexplatillos.forEach(indexplatillo => {
            ...
            resultadosIndex+=`
                <div class="cuadricula_items">
                    <div class="cuadricula_caja">
                    <div class="imgabebi">
                        <img src="../${indexplatillo.foto}" class="imgbebi" class="card-img-top" alt="..." onclick="openFulImg(this.src)" >
                    </div>
